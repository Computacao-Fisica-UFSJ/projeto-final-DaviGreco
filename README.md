...
| **03/12** | Quarta | • Desenvolvimento da lógica de**Monitoramento das Chaves** (Painel). • Integração dos sistemas (Autenticação -> Liberação -> Log).`<br>`• Implementação do sistema de Alarme.                                                |
